...
-spec serialise_bloom(array(), {hash_algo(), pos_integer()}, pos_integer())
                                                                    -> gcs().
serialise_bloom(HashLists, {HA, HashBitsRequired}, FPRFactor) ->
...
size_block_tester() ->
    ...
    multi_block_tester(13000, BitsPK, TestCount, KeyType, HashAlgo, PackType).
